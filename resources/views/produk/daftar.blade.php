...
@section('menu-penjualan', 'open')
@section('menu-produk', 'active')
@section('konten')
<div class="row">
	<div class="col-md-12">
		<!-- DATA TABLE -->
		<h3 class="title-5 m-b-35">Daftar Produk</h3>
		<div class="table-data__tool">
			<div class="table-data__tool-left">
				<div class="table-data__tool-right">
					<button class="au-btn au-btn-icon au-btn--green au-btn--small" style="float: right" data-toggle="modal" data-target="#ModalCreate">
							...
							<div class="modal-dialog modal-lg" role="document">
								<div class="modal-content">
									...
									<div class="modal-body">
										<form action="{{ route('produk-admin.store') }}" method="POST" enctype="multipart/form-data">
											@csrf
											<div class="row form-group">
												...
												<div class="col-12 col-md-9">
													<input type="text" id="nama_produk" name="nama_produk" value="{{ old('nama_produk') }}" class="form-control">
												</div>
											</div>
											<div class="row form-group">
												<div class="col col-md-3">
											...
											<div class="row form-group">
												...
												<div class="col-12 col-md-9">
													<input type="text" id="stok" name="stok" value="{{ old('stok') }}" class="form-control">
												</div>
											</div>
											<div class="row form-group">
												<div class="col col-md-3">
												...
												<div class="col-12 col-md-9">
													<input type="text" id="harga" name="harga" value="{{ old('harga') }}" class="form-control">
												</div>
											</div>
											...
											<div class="row form-group">
												...
												<div class="col-12 col-md-9">
													<input type="file" id="gambar" name="gambar" value="{{ old('gambar') }}" class="form-control">
												</div>
											</div>
										</div>
								...
								<tr class="tr-shadow">
									...
									<td>
										<div class="table-data-feature">
											<button class="item" data-toggle="modal" data-target="#ModalEdit{{ $loop->iteration }}" data-toggle2="tooltip" data-placement="top" title="Edit">
												<i class="zmdi zmdi-edit"></i>
											</button>
											<button class="item" data-toggle="modal" data-target="#ModalDelete{{ $loop->iteration }}" data-toggle2="tooltip" data-placement="top" title="Delete">
												<i class="zmdi zmdi-delete"></i>
											</button>
										</div>
									</td>
								</tr>
								<div class="modal fade" style="margin-top: 14%;" id="ModalDelete{{ $loop->iteration }}" tabindex="-1" role="dialog" aria-labelledby="smallModalLabel" aria-hidden="true">
									<div class="modal-dialog modal-sm" role="document">
										<div class="modal-content">
											...
											<div class="modal-footer">
												<button type="button" class="btn btn-secondary" data-dismiss="modal">Batal</button>
												<a href="{{ route('produk-admin.destroy', $p->produk_id) }}" class="btn btn-danger">Ya</a>
											</div>
										</div>
									</div>
								</div>
								<div class="modal fade" id="ModalEdit{{ $loop->iteration }}" tabindex="-1" role="dialog" aria-labelledby="mediumModalLabel" aria-hidden="true">
									<div class="modal-dialog modal-lg" role="document">
										<div class="modal-content">
											<div class="modal-header">
											...
											<div class="modal-body">
												...
												?>
												<form action="{{ route('produk-admin.update', $p->produk_id) }}" method="POST" enctype="multipart/form-data">
													@csrf
													@method('PUT')
