...
<head>
    ...
    <link href="{{ asset('plugins/admin/vendor/vector-map/jqvmap.min.css') }}" rel="stylesheet" media="all">

    <!-- Main CSS-->
    <link href="{{ asset('plugins/admin/css/theme.css') }}" rel="stylesheet" media="all">
    <link href="{{ asset('plugins/user/css/custom.css') }}" rel="stylesheet">
...
<body class="animsition">
    <div class="page-wrapper">
        ...
        <aside class="menu-sidebar2">
            <div class="logo">
                <a href="#" style="font-family: arial; font-size: 20px; font-stretch: bold; color: white;">
                    <img src="{{ asset('img/logo_swtw.jpg') }}" style="height: 35%; width: 35%;" alt="SweeTwins" /> SweeTwins
                </a>
            </div>
            <div class="menu-sidebar2__content js-scrollbar1">
                <div class="account2">
                    <div class="image img-cir img-120">
                        <img src="{{ asset('img/dena_dwi.jpg') }}" alt="Admin Cute" />
                    </div>
                    <h4 class="name">Admin Cute</h4>
                ...
                <nav class="navbar-sidebar2">
                    <ul class="list-unstyled navbar__list">
                        ...
                        <li class="has-sub">
                            ...
                            <ul class="list-unstyled navbar__sub-list js-sub-list" @if(Request::is('produk') == 'active') style="display: block;" @elseif(Request::is('penjualan') == 'active') style="display: block;" @endif>
                                <li class="{{ Request::is('produk') ? 'active' : '' }} has-sub">
                                    <a href="{{ url('produk') }}">Produk</a>
                                </li>
                                <li class="{{ Request::is('penjualan') ? 'active' : '' }} has-sub">
        ...
        <div class="page-container2">
                    ...
                    <div class="container-fluid">
                        <div class="header-wrap2">
                            <div class="logo d-block d-lg-none">
                                <h4 style="color: #ffffff; font-family: arial; font-stretch: bold; font-size: 20px;">SweeTwins</h4>
                            </div>
            ...
            <aside class="menu-sidebar2 js-right-sidebar d-block d-lg-none">
                <div class="logo">
                    <a href="#">
                        <img src="{{ asset('img/logo_swtw.jpg') }}" style="height: 35%; width: 35%;" alt="SweeTwins" />
                    </a>
                </div>
    ...
    <script src="{{ asset('plugins/admin/vendor/vector-map/jquery.vmap.js') }}"></script>
    <script src="{{ asset('plugins/admin/vendor/vector-map/jquery.vmap.min.js') }}"></script>
    <script src="{{ asset('plugins/admin/vendor/vector-map/jquery.vmap.sampledata.js') }}"></script>
    <script src="{{ asset('plugins/admin/vendor/vector-map/jquery.vmap.world.js') }}"></script>
